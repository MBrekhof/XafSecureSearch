...
using System.Text;
using XafSecureSearch.Blazor.Server.Services;
using XafSecureSearch.WebApi.JWT;
...
namespace XafSecureSearch.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<XafSecureSearchBlazorApplication>();
                ...
                builder.Modules
                    ...
                    .AddViewVariants()
                    .Add<XafSecureSearch.Module.XafSecureSearchModule>()
                    .Add<XafSecureSearchBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<XafSecureSearch.Module.BusinessObjects.XafSecureSearchEFCoreDbContext>((serviceProvider, options) =>
                    {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(XafSecureSearch.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(XafSecureSearch.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "XafSecureSearch API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the XafSecureSearch.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafSecureSearch WebApi v1");
                });
            }
            else
            {
